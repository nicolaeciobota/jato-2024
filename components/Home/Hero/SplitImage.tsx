...
const SplitImage = ({ heroTitle, heroSubtitle, buttons, image }: Props) => {
  return (
    <div className="relative mt-24 flex flex-col-reverse sm:py-16 py-8 lg:flex-col lg:pb-0 lg:pt-0 dark:bg-dark-background">
      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col items-start px-4 md:px-0 lg:max-w-screen-xl lg:px-8">
        <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
          ...
          <div className="flex items-center sm:flex-row flex-col-reverse sm:gap-0 gap-5">
            {buttons.map((button) => {
              const primary =
                'hover:bg-primary/90 focus:shadow-outline sm:mr-6 inline-flex h-12 items-center justify-center rounded bg-primary px-6 font-medium tracking-wide text-white shadow-md transition duration-200 focus:outline-none';
              const secondary =
