import SharePost from "@/components/Agenda/Talk/ShareTalk";
import TagButton from "@/components/Agenda/DateTagButton";
          ...
          <div className="w-full px-4 lg:w-8/12">
            <div>
              ...
              <div className="mb-10 flex items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                ...
                <div className="mb-5">
                  <a
                    href={`/${lng}/talk/dates/${data.talk.dateTags[0].slug}`}
                    className="inline-flex items-center justify-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white"
                  >
                    {data.alltalks.dateTags[0].tag}
                  </a>
                </div>
              </div>
              <div>
