...
export type AgendaTabQuery = { __typename?: 'Query', allAgendaTabs: Array<{ __typename?: 'AgendaTabRecord', _publishedAt?: string | null, date: string, title: string, id: string, talk: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, description: string, start: string, end?: string | null, dateTags: Array<{ __typename?: 'DateTagRecord', id: string, eventDate: string, slug: string }>, stage: { __typename?: 'StageRecord', id: string, name: string, slug: string }, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, jobTitle: string, id: string, slug: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }> }>, _allAgendaTabsMeta: { __typename?: 'CollectionMetadata', count: number } };
...
export type TalksQuery = { __typename?: 'Query', allTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, description: string, start: string, end?: string | null, dateTags: Array<{ __typename?: 'DateTagRecord', eventDate: string }>, stage: { __typename?: 'StageRecord', id: string, name: string, slug: string }, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, jobTitle: string, slug: string, id: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }>, _allTalksMeta: { __typename?: 'CollectionMetadata', count: number } };
