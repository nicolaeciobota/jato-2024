...
export type AwardModelContentBlocksField =
  | AppCtaRecord
...
export type LegalPageRecord = RecordInterface & {
  ...
  _allContentLocales?: Maybe<
    Array<LegalPageModelContentFieldNonNullMultiLocaleField>
  >;
  _allTitleLocales?: Maybe<Array<StringNonNullMultiLocaleField>>;
  _createdAt: Scalars["DateTime"]["output"];
  /** Editing URL */
...
export type PageRecord = RecordInterface & {
  ...
  _allSectionsLocales?: Maybe<
    Array<PageModelSectionsFieldListListNonNullMultiLocaleField>
  >;
...
export type PostRecord = RecordInterface & {
  ...
  _allContentLocales?: Maybe<
    Array<PostModelContentFieldNonNullMultiLocaleField>
  >;
...
export type TestimonialRecord = RecordInterface & {
  ...
  _allReviewLocales?: Maybe<
    Array<TestimonialModelReviewFieldNonNullMultiLocaleField>
  >;
  _createdAt: Scalars["DateTime"]["output"];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars["String"]["output"]>;
  ...
  award?: {
    ...
    content: {
      ...
      links: Array<{
        ...
        id: string;
        title: string;
        atags: Array<{ __typename?: "AtagRecord"; atag: string }>;
        seoTags?: {
          __typename?: "SeoField";
          description?: string | null;
          image?: {
...
export type AwardCategoryQuery = {
  __typename?: "Query";
  acategory?: {
    __typename?: "AcategoryRecord";
    name: string;
...
export type AwardsQuery = {
  ...
  _allAwardsMeta: { __typename?: "CollectionMetadata"; count: number };
};
...
export type DatetagQuery = {
  __typename?: "Query";
  dateTag?: {
    __typename?: "DateTagRecord";
    eventDate: string;
    _allReferencingTalks: Array<{
      __typename?: "TalkRecord";
      _publishedAt?: string | null;
      slug: string;
      id: string;
      title: string;
      dateTags: Array<{ __typename?: "DateTagRecord"; eventDate: string }>;
      stage?: { __typename?: "StageRecord"; name: string; slug: string } | null;
      seoTags?: {
        __typename?: "SeoField";
        description?: string | null;
        image?: {
...
export type DocumentationHomePageQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type DocumentationSidebarQueryVariables = Exact<{
  [key: string]: never;
}>;
...
export type PageQuery = {
  ...
  _allTalksMeta: { __typename?: "CollectionMetadata"; count: number };
};
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "fallbackLocale" },
          },
          type: {
            kind: "ListType",
            type: {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "preHeader" },
                            },
                            {
                              kind: "Field",
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "subheader" },
                            },
                            {
                              kind: "Field",
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "acategory" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "name" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "atags" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                      { kind: "Field", name: { kind: "Name", value: "atag" } },
                      { kind: "Field", name: { kind: "Name", value: "slug" } },
                    ],
                  },
                },
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              typeCondition: {
                                ...
                                name: {
                                  kind: "Name",
                                  value: "CtaButtonWithImageRecord",
                                },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
...
} as unknown as DocumentNode<AwardQuery, AwardQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AwardCategory" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "_allReferencingAwards" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "filter" },
...
} as unknown as DocumentNode<AwardCategoryQuery, AwardCategoryQueryVariables>;
export const AwardsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "allAwards" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "filter" },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "_allAwardsMeta" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "locale" },
...
} as unknown as DocumentNode<AwardsQuery, AwardsQueryVariables>;
export const AwardTagDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AwardTag" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
...
} as unknown as DocumentNode<AwardTagQuery, AwardTagQueryVariables>;
...
export const CustomColorDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const DatetagDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "Datetag" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "slug" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "_allReferencingTalksMeta" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "locale" },
...
} as unknown as DocumentNode<DatetagQuery, DatetagQueryVariables>;
...
export const DocumentationSidebarDocument = {
  ...
  DocumentationSidebarQuery,
  DocumentationSidebarQueryVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: "Field",
                  name: { kind: "Name", value: "footerSubtitle" },
                },
                {
                  kind: "Field",
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      },
                      {
                        ...
                        typeCondition: {
                          kind: "NamedType",
                          name: { kind: "Name", value: "ScheduleRecord" },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "heroSubtitle" },
                            },
                            {
                              kind: "Field",
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "videoHeader" },
                            },
                            {
                              kind: "Field",
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "pricingSectionSubheader",
                              },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "displayOption" },
                            },
                            {
                              kind: "Field",
                      ...
                      },
                      {
                        ...
                        typeCondition: {
                          ...
                          name: {
                            kind: "Name",
                            value: "FeaturedPostsSectionRecord",
                          },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                      ...
                      },
                      {
                        ...
                        typeCondition: {
                          ...
                          name: {
                            kind: "Name",
                            value: "FeatureListSectionRecord",
                          },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "featuresHeader" },
                            },
                            {
                              kind: "Field",
                              name: {
                                kind: "Name",
                                value: "featuresSubheader",
                              },
                            },
                            {
                              kind: "Field",
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "slugToRedirectTo" },
                            },
                          ],
                        },
                      },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "_allTalksMeta" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "locale" },
...
} as unknown as DocumentNode<SpeakerQuery, SpeakerQueryVariables>;
...
} as unknown as DocumentNode<TalkQuery, TalkQueryVariables>;
        ...
        selections: [
          {
            ...
            arguments: [
              ...
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "first" },
                value: { kind: "StringValue", value: "30", block: false },
              },
              {
                kind: "Argument",
                name: { kind: "Name", value: "locale" },
...
} as unknown as DocumentNode<TalksQuery, TalksQueryVariables>;
