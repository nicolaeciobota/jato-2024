...
/** Block of type Iframe Block (iframe_block) */
...
export type PageModelSectionsField = AboutIntroRecord | AllAgendaTabsSectionRecord | AllAwardsSectionRecord | AllCategoryAwardsSectionRecord | AllPostsSectionRecord | AllStagesSectionRecord | AllTalksSectionRecord | BannerBlockRecord | BrandSectionRecord | ChangelogSectionRecord | DetailSectionRecord | FaqSectionRecord | FeatureListSectionRecord | FeaturedAcategorySectionRecord | FeaturedPostsSectionRecord | HeroSectionRecord | IframeBlockRecord | IvsLiveStageRecord | MuxLiveStreamRecord | PricingSectionRecord | RedirectSectionRecord | ReviewSectionRecord | SpeakerSectionRecord | SpeakersIntroRecord | StatsSectionRecord | TeamSectionRecord | VideoSectionRecord;
