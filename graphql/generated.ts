...
/** Specifies how to filter by linking fields */
export type InverseRelationshipFieldFilterBetweenStageAndSpeaker = {
  /** Filter linking records that reference current record in at least one of the specified fields */
  anyIn?: InputMaybe<Array<StageModelFieldsReferencingSpeakerModel>>;
  /** Filter linking records that do not reference current record in any of the specified fields */
  notIn?: InputMaybe<Array<StageModelFieldsReferencingSpeakerModel>>;
};
...
/** Specifies how to filter linking records */
export type InverseRelationshipFilterBetweenStageAndSpeaker = {
  /** Specifies how to filter by linking fields */
  fields?: InputMaybe<InverseRelationshipFieldFilterBetweenStageAndSpeaker>;
  /** Specifies how to filter by linking locales */
  locales?: InputMaybe<LinkingLocalesFilter>;
};
...
export type PageModelSectionsField = AboutIntroRecord | AllAwardsSectionRecord | AllPostsSectionRecord | AllTalksSectionRecord | BrandSectionRecord | ChangelogSectionRecord | DetailSectionRecord | FaqSectionRecord | FeatureListSectionRecord | FeaturedPostsSectionRecord | HeroSectionRecord | PricingSectionRecord | RedirectSectionRecord | ReviewSectionRecord | ScheduleRecord | StatsSectionRecord | TeamSectionRecord | VideoSectionRecord;
...
/** Record of type 👩‍🏫 Speaker (speaker) */
export type SpeakerRecord_AllReferencingStagesArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<StageModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<StageModelOrderBy>>>;
  skip?: InputMaybe<Scalars['IntType']['input']>;
  through?: InputMaybe<InverseRelationshipFilterBetweenStageAndSpeaker>;
};


/** Record of type 👩‍🏫 Speaker (speaker) */
export type SpeakerRecord_AllReferencingStagesMetaArgs = {
  filter?: InputMaybe<StageModelFilter>;
  locale?: InputMaybe<SiteLocale>;
  through?: InputMaybe<InverseRelationshipFilterBetweenStageAndSpeaker>;
};
...
/** Linking fields */
export enum StageModelFieldsReferencingSpeakerModel {
...
export type DatetagQuery = { __typename?: 'Query', dateTag?: { __typename?: 'DateTagRecord', eventDate: string, _allReferencingTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, dateTags: Array<{ __typename?: 'DateTagRecord', eventDate: string }>, stage?: { __typename?: 'StageRecord', name: string, slug: string } | null, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, bio: string, slug: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }>, _allReferencingTalksMeta: { __typename?: 'CollectionMetadata', count: number } } | null };
...
export type SpeakerQuery = { __typename?: 'Query', speaker?: { __typename?: 'SpeakerRecord', name: string, title: string, bio: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null }, _allReferencingTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, dateTags: Array<{ __typename?: 'DateTagRecord', id: string, eventDate: string, slug: string }>, stage?: { __typename?: 'StageRecord', id: string, name: string, slug: string } | null, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }>, _allReferencingTalksMeta: { __typename?: 'CollectionMetadata', count: number } } | null };
...
export type TalkQuery = { __typename?: 'Query', talk?: { __typename?: 'TalkRecord', _publishedAt?: string | null, title: string, description: string, start: string, end?: string | null, stage?: { __typename?: 'StageRecord', id: string, name: string, slug: string } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }>, dateTags: Array<{ __typename?: 'DateTagRecord', id: string, eventDate: string, slug: string }> } | null };
...
export type TalksQuery = { __typename?: 'Query', allTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, dateTags: Array<{ __typename?: 'DateTagRecord', eventDate: string }>, stage?: { __typename?: 'StageRecord', id: string, name: string, slug: string } | null, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, slug: string, bio: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }>, _allTalksMeta: { __typename?: 'CollectionMetadata', count: number } };
