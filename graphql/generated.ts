...
export type StageQuery = { __typename?: 'Query', stage?: { __typename?: 'StageRecord', _publishedAt?: string | null, name: string, streamKey?: string | null, talk: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, slug: string, id: string, title: string, description: string, start: string, end?: string | null, stage: { __typename?: 'StageRecord', id: string, name: string, slug: string }, dateTags: Array<{ __typename?: 'DateTagRecord', id: string, eventDate: string, slug: string }>, speaker: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } }> }> } | null };
