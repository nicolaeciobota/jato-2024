...
export type TalkQuery = { __typename?: 'Query', talk?: { __typename?: 'TalkRecord', _publishedAt?: string | null, title: string, description: string, start: string, end?: string | null, talkSpeakers: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null, _allReferencingTalks: Array<{ __typename?: 'TalkRecord', stages: { __typename?: 'StageRecord', name: string, slug?: string | null, id: string } }> }>, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null } | null };
...
export type TalksQuery = { __typename?: 'Query', allTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, title: string, description: string, start: string, end?: string | null, talkSpeakers: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null, _allReferencingTalks: Array<{ __typename?: 'TalkRecord', stages: { __typename?: 'StageRecord', slug?: string | null, name: string } }> }>, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null }>, _allTalksMeta: { __typename?: 'CollectionMetadata', count: number } };
