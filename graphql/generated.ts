...
export enum StageModelFieldsReferencingSpeakerModel {
  StageScheduleList = 'stage_scheduleList'
}
...
export type StageModelFilter = {
  ...
  id?: InputMaybe<ItemIdFilter>;
  name?: InputMaybe<StringFilter>;
  scheduleList?: InputMaybe<StructuredTextFilter>;
  slug?: InputMaybe<SlugFilter>;
...
export type StageModelScheduleListField = {
  __typename?: 'StageModelScheduleListField';
  blocks: Array<StageScehduleItemRecord>;
  links: Array<SpeakerRecord>;
  value: Scalars['JsonField']['output'];
};
...
export type StageRecord = RecordInterface & {
  ...
  id: Scalars['ItemId']['output'];
  name: Scalars['String']['output'];
  scheduleList: StageModelScheduleListField;
...
export type TalkQuery = { __typename?: 'Query', talk?: { __typename?: 'TalkRecord', _publishedAt?: string | null, title: string, description: string, start: string, end?: string | null, talkSpeakers: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null }>, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null } | null };
...
export type TalksQuery = { __typename?: 'Query', allTalks: Array<{ __typename?: 'TalkRecord', _publishedAt?: string | null, title: string, description: string, start: string, end?: string | null, talkSpeakers: Array<{ __typename?: 'SpeakerRecord', name: string, title: string, bio: string, slug: string, picture?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null }>, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: { __typename?: 'ResponsiveImage', srcSet: string, webpSrcSet: string, sizes: string, src: string, width: number, height: number, aspectRatio: number, alt?: string | null, title?: string | null, bgColor?: string | null, base64?: string | null } | null } | null } | null }>, _allTalksMeta: { __typename?: 'CollectionMetadata', count: number } };
